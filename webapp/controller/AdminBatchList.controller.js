sap.ui.define([
	...
	return Controller.extend("portal.controller.AdminBatchList", {
		onInit: function() {
			this.oModel = new JSONModel();
			this.oModel.loadData(sap.ui.require.toUrl("portal/model/batchlist.json"), null, false);
			...
			this.oSelectCategory = this.getSelect("slResult");
		...
		onSelectChange: function() {
			...
			aCurrentFilterValues.push(this.getSelectedItemText(this.oSelectResult));
