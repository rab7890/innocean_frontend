sap.ui.define([
    ...
    return Controller.extend("portal.controller.AdminDailySite", {

        onInit: function () {
            var oModel = new JSONModel(sap.ui.require.toUrl("portal/model/dailysite.json"));
            this.getView().setModel(oModel);

            this._bDescendingSort = false;
            this.oProductsTable = this.oView.byId("DailySiteTable");
        },
