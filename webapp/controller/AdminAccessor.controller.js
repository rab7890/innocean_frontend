sap.ui.define([
    ...
    return Controller.extend("portal.controller.AdminAccessor", {

        onInit: function () {
            var oModel = new JSONModel(sap.ui.require.toUrl("portal/model/accessor.json"));
            this.getView().setModel(oModel);

            this._bDescendingSort = false;
            this.oProductsTable = this.oView.byId("AccessorTable");
        },
