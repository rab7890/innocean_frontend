sap.ui.define([
	...
	return Controller.extend("portal.controller.AdminNotice", {
		onInit: function () {          
			var oModel = new JSONModel(sap.ui.require.toUrl("portal/model/notice.json"));
		...
		onAdd: function () {
			var oRouter = this.getOwnerComponent().getRouter();
                oRouter.navTo("AdminNotiRegiste");
		},
