sap.ui.define([
    ...
    return Controller.extend("portal.controller.AdminUseStatus", {

        onInit: function () {
            var oModel = new JSONModel(sap.ui.require.toUrl("portal/model/usedlog.json"));
            this.getView().setModel(oModel);

            this._bDescendingSort = false;
            this.oProductsTable = this.oView.byId("AdminUseStatus");
        },
